    ...
    <div class='bg-white py-6 sm:py-8 lg:py-12'>
      <div class='max-w-screen-xl px-4 md:px-8 mx-auto'>
        <div class='grid md:grid-cols-2 gap-8 lg:gap-12'>
          ...
          <div class='md:pt-8'>
            <p class='bg-iggy-green font-bold text-center md:text-left'>
              Who we are
            </p>
            ...
            <p class='text-gray-500 sm:text-lg mb-6 md:mb-8'>
              ...
              <a
                href='#'
                class='bg-iggy-green hover:bg-iggy-green active:bg-iggy-green underline transition duration-100'
              >
                random
              </a>{' '}
